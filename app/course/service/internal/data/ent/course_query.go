...
func (cq *CourseQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (cq *CourseQuery) FirstIDX(ctx context.Context) int64 {
...
func (cq *CourseQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (cq *CourseQuery) OnlyIDX(ctx context.Context) int64 {
...
func (cq *CourseQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (cq *CourseQuery) IDsX(ctx context.Context) []int64 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
