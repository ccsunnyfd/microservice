...
import (
	...
	"microservice/app/course/service/internal/data/ent"
...
func NewEntClient(conf *conf.Data, logger log.Logger) *ent.Client {
	log1 := log.NewHelper(log.With(logger, "module", "course-service/data/ent"))
...
func NewData(
	...
	l := log.NewHelper(log.With(logger, "module", "course-service/data"))
