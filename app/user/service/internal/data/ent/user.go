...
func (*User) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldStars:
			values[i] = new(sql.NullInt64)
		case user.FieldName, user.FieldPassword, user.FieldRealName, user.FieldMobile, user.FieldEmail:
...
func (u *User) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", u.Stars))
	builder.WriteByte(')')
